        ...
        <div class="col-lg-12">
            ...
            <div class="bg-white p-4">
                <div class="contact-information">
                    <h5>LJ Polytechnic</h5>
                    <div class="row">
                        <div class="col-md-8">
                            <table class="table table-sm" style="font-size: 12px;">
                                <tr>
                                    <td>Rings of Life</td>
                                    <td><i class="mdi mdi-deskphone mr-3"></i>+91 XXXXXXXXXX</td>
                                </tr>
                                <tr>
                                    <td>near sanand circle</td>
                                    <td><i class="mdi mdi-phone mr-3"></i> +91 XXXXXXXXXX</td>
                                </tr>
                                <tr>
                                    <td>SG Highway</td>
                                    <td><i class="mdi mdi-email mr-3"></i> admin@gmail.com</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <form action="" method="post" style="font-size: 12px;">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="contact_email" placeholder="Enter email">
                                        </div>
                                        <div class="form-group col-md-12 mb-1">
                                ...
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3672.8858577707824!2d72.48585367403697!3d22.991224417499726!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e9bc4ce73bf61%3A0x323634959dab072f!2sLJ%20University!5e0!3m2!1sen!2sin!4v1705398995468!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
